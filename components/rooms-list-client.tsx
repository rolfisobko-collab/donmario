      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          {filteredRooms.length === 0 ? (
            <div className="bg-card rounded-xl p-8 sm:p-12 text-center border border-dashed">
              <p className="text-lg sm:text-xl text-muted-foreground mb-4">No hay habitaciones disponibles con estos filtros.</p>
                  ...
                  <div className="lg:w-2/3 p-4 sm:p-5 flex flex-col justify-between">
                    <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
                      <div className="flex-1">
                        ...
                        <h3 className="text-xl sm:text-2xl font-bold text-primary mb-2 group-hover:underline decoration-2 underline-offset-4">
                          {room.title}
                        </h3>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 pt-4 border-t">
                      <div>
