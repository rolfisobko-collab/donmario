            ...
            <CarouselContent className="-ml-6">
              {displayRooms.map((room, index) => (
                <CarouselItem key={index} className="pl-6 md:basis-1/2 lg:basis-1/3">
                  <Card className="border-none shadow-xl hover:shadow-2xl transition-all duration-500 group overflow-hidden rounded-2xl border border-amber-200/50 bg-white/95 backdrop-blur-sm h-full flex flex-col">
